...
The shortest tour found was 5594.68, found with pop_size = 500, mut_rate = 0.25, and nthread = 2 (my machine only
has four cores, so nthread's performance boost is limited to two threads).
